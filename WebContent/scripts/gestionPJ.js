...
if (navigator.appName == "Microsoft Internet Explorer") {
 ...
 Init_IE_getElementsByName();
  ...
  // Concerne la datagrid enfants :
	//
	var datagridName = "listeFichiers";
  ...
  function Enfants_setRequired(numLine) {
				...
				// Pour suppression :
		Enfants_insertHTML(numLine+1,posColEnfant_regime,'<a href="javascript:Datagrid_DelLine('+numLine+')"><img src="'+imgsrc+'delete.gif" alt="Supprimer cette pièce jointe" title="Supprimer cette pièce jointe"></a>'); // Ajout du bouton de suppression
  	...
  	document.getElementsByName(datagridName + '.codeRegime['+numLine+']')[0].onclick = function() {
			select_disableComment(document.getElementsByName(datagridName + '.codeRegime['+numLine+']')[0]);  
	  }
  	document.getElementsByName(datagridName + '.codeRegime['+numLine+']')[0].onchange = function() {
	  	select_removeComment(document.getElementsByName(datagridName + '.codeRegime['+numLine+']')[0]);   	
  	...
  	document.getElementsByName(datagridName + '.anneeNaissance['+numLine+']')[0].onclick = function() {
			select_disableComment(document.getElementsByName(datagridName + '.anneeNaissance['+numLine+']')[0]);  
	  }
  	document.getElementsByName(datagridName + '.anneeNaissance['+numLine+']')[0].onchange = function() {
  		isSelectboxValide(this);
	  	select_removeComment(document.getElementsByName(datagridName + '.anneeNaissance['+numLine+']')[0]);
  	}  	
  	...
  	document.getElementsByName(datagridName + '.moisNaissance['+numLine+']')[0].onclick = function() {
	  	select_disableComment(document.getElementsByName(datagridName + '.moisNaissance['+numLine+']')[0]);
	  }
  	document.getElementsByName(datagridName + '.moisNaissance['+numLine+']')[0].onchange = function() {
	  	select_removeComment(document.getElementsByName(datagridName + '.moisNaissance['+numLine+']')[0]);  	
  		isSelectboxValide(this);
  	}  	
  	...
  	document.getElementsByName(datagridName + '.jourNaissance['+numLine+']')[0].click = function() {
	  	select_disableComment(document.getElementsByName(datagridName + '.jourNaissance['+numLine+']')[0]);
	  }
  	document.getElementsByName(datagridName + '.jourNaissance['+numLine+']')[0].onchange = function() {
	  	select_removeComment(document.getElementsByName(datagridName + '.jourNaissance['+numLine+']')[0]);  	
  		isSelectboxValide(this);
  	}  	
	...
	function Enfant_INIT() {
  	...
  	if (Enfants_getCountLines()>0) {
  		for (var numLine=0;numLine<Enfants_getCountLines();++numLine) {
  			...
  			isSelectboxValide(document.getElementsByName(datagridName + '.codeRegime['+numLine+']')[0]);
  			isSelectboxValide(document.getElementsByName(datagridName + '.anneeNaissance['+numLine+']')[0]);
  			isSelectboxValide(document.getElementsByName(datagridName + '.moisNaissance['+numLine+']')[0]);
  			isSelectboxValide(document.getElementsByName(datagridName + '.jourNaissance['+numLine+']')[0]);
  		}
  	}
