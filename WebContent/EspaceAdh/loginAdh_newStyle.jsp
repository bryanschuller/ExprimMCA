<%
        ...
        Cookie cookie1 = new Cookie("typeAcces", "AB");
...
<p class="avert" align="center">Si vous avez oubli&eacute; votre mot de passe, <a href="<%= (String)request.getContextPath() %>/forgetPswd.do?typeAcces=<%= typeAcces %>"  target="_top">cliquez ici.</a></p>
