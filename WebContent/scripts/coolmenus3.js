...
function makePageCoords(win,fr){
	...
	this.leftborder=this.x50-504;  // ajustement de la bordure gauche !?!?!?
	return this;
}
/*************
Debugging function
...
EXCEPT 
!!!  SOURCE MODIFIE PAR MN POUR OBTENIR UN MENU CENTRE AUTOMATIQUEMENT SUR LA PAGE

AJOUT DE LA VARIABLE toppage.leftborder CALCULE POUR UN MENU DE 700 PX ....
...
function cm_makeTop(rr){
	...
	border=this.l[0].border;y=this.checkp(this.fromtop,0,0,1)+border;x=this.checkp(toppage.leftborder,0,0,1)+border
