...
******************************************************************************/
/* le 04/01/08      correctif ?i-dessous cf: http://ezinearticles.com/?IE-7-Cool-Menus-3-and-4-Not-Working?-Quick-Fix-with-a-Replacement-Browser-Check-Function-Script&id=430332
...
oCMenu.barcolor="#55656C" //The color of the background bar - Value: "color"
...
oCMenu.barbordercolor="#FFFFFF"


//Placement properties

/************** Except *****************/
// 1= menu en ligne 0=en colonnes
...
oCMenu.fromtop=261 //This is the top position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
...
oCMenu.level[0].width=164 //The default width for each level[0] (top) items. You can override this on each item by spesifying the width when making the item. - Value: px || "%"
...
oCMenu.level[0].bgcoloroff="#55656C" // "#339999" The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
oCMenu.level[0].bgcoloron= "#BBBBBB" // "#99CCCC"The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
oCMenu.level[0].textcolor= "#FFFFFF"// "#FFFFFF" The default text color for each level[0] (top) items. You can override this on each item by spesifying the text color when making the item. - Value: "color"
oCMenu.level[0].hovercolor="##FFFFF" //The default "on" text color for each level[0] (top) items. You can override this on each item by spesifying the "on" text color when making the item. - Value: "color"
oCMenu.level[0].style="padding:2px; font-family:tahoma,arial,helvetica; font-size:9pt; text-align:center" //The style for all level[0] (top) items. - Value: "style_settings" font-weight:bold
oCMenu.level[0].border=1 //The border size for all level[0] (top) items. - Value: px
oCMenu.level[0].bordercolor="#D03010" //"#339999"The border color for all level[0] (top) items. - Value: "color"

/************** Except *****************/
// décalage en X et Y pour afficher le menu par rapport à l'élément parent
...
*/
/************** Except *****************/
// détermine de quel coté s'affiche un sous-menu
...
oCMenu.level[1].style="padding:2px; font-family:tahoma, arial,helvetica; font-size:9pt"
...
oCMenu.level[2].width=145 // oCMenu.level[1].width
oCMenu.level[2].height=20
//oCMenu.level[2].bgcoloroff="#009999"
//oCMenu.level[2].bgcoloron="#0099cc"
oCMenu.level[2].style="padding:2px; font-family:tahoma,arial,helvetica; font-size:9pt"
...
// menu arrows
/************** Except *****************/
// image associée à un menu

cmTopMenuImage='        <img src="/MCA/images/Darrow.gif">'
cmSubMenuImage='<img src="/MCA/images/Rarrow.gif">'
