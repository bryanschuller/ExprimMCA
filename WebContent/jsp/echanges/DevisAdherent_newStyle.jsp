...
<html>
<head>
	<base href="https://www.mc-alsace.fr/MCA/Commun/DevisAdherent_newStyle.jsp">	
 <%-- <base href="http://127.0.0.1:8080/MCA/Commun/DevisAdherent_newStyle.jsp">	--%>
...
<tr><td colspan="2">
		...
		<%-- Vous --%>
						...
						<img name="jourNaissAdhrequired" src="/MCA/images/ast.gif">
						...
						<img name="moisNaissAdhrequired" src="/MCA/images/ast.gif">
						...
						<img name="anneeNaissAdhrequired" src="/MCA/images/ast.gif">
...
<tr><td colspan="2">
					...
					<img name="codeRoAdhrequired" src="/MCA/images/ast.gif">
...
<p><span><bean:message key="devis.birthdate"/></span>
							...
							<img name="jourNaissConjrequired" src="/MCA/images/ast.gif">
							...
							<img name="moisNaissConjrequired" src="/MCA/images/ast.gif">
							<layout:select key="" property="anneeNaissConj" onchange="select_removeComment(this)" isRequired="true" layout="false">
								<layout:option value="-" key="devis.listYear"/>
								<layout:options property="years"/> 
							</layout:select>
							<img name="anneeNaissConjrequired" src="/MCA/images/ast.gif">
</p>
	...
	<p><span><bean:message key="devis.regime"/></span>
						...
						<img name="codeRoConjrequired" src="/MCA/images/ast.gif">
</p>
</div>
		</td></tr>
	...
	<%--		<layout:panel key="<div align='left'><b>&nbsp;<bean:message key="devis.child"/></b></div>"  styleClass="DEVIS_ENFANTS"> --%>
			...
			<tr><td colspan="2">
				<h2 id="enfants"><span>Vos enfants :</span></h2>
				  <a href="javascript:ajouterEnfant()">	<img src="/MCA/images/Prospectiv/bt_ajouterenfant.gif" class="BOUT1"/> </a>
							<p/>
				</td></tr>
...
<!-- <bean:message key="devis.launchCalculation"/> -->
					...
					<%-- Submit --%>
					<!-- 		<layout:submit styleClass="sans"  ></layout:submit><img src="/MCA/images/Prospectiv/bt_afficher.gif"/> -->
...
<tr><td colspan="2">
		...
		<br />
				...
				<p><span class="s2"><bean:message key="devis.alineaMontant"/></span></p>
