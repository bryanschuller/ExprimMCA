...
<logic:equal name="dossierActuel" property="codeGroupe" value="OPT">
	...
	<br/>
	<logic:equal name="internaute" property="modeAcces" value="xxx">
		<BR>
...
<logic:equal name="dossierActuel" property="numAdherent" value="8888888">
	<BR>
		<a href="<%= (String) request.getContextPath() %>/creerPEC.do?type=AUD"><layout:message key="pec.libelle.creer.AUD" /></a>
	<br/>
</logic:equal>
...
<div style="width:100%;">
	...
	<logic:equal name="internaute" property="modeAcces" value="xxx">
		<exged:listeDocExged name="DocSaisiePOW" 
			...
			<exged:paramSearchExged paramName="CODE_DOC" paramValue="LAVALUE='DOC_SAISIE_PEC_OPT_WEB'" />	
