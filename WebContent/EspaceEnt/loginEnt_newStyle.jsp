<%
        ...
        Cookie cookie1 = new Cookie("typeAcces", "GE");
        cookie1.setMaxAge(24 * 60 * 60);
        cookie1.setPath((String)request.getContextPath());
...
<%--		<base href="https://www.mc-alsace.fr/MCA/EspaceEnt/loginEnt_newStyle.jsp">
			<base href="http://localhost:8080/MCA/EspaceEnt/loginEnt_newStyle.jsp">   --%>
...
<tr>
    <td valign="top">
        ...
        <tr>
            ...
            <tr>
                <th class="LOGIN_LABEL"><span class="LOGIN_LABEL LOGIN"><bean:message key="app.ent.identifiant"/></span></th>
		...
		<input type="hidden" name="typeAcces" value="MAP.ENT">  
        <%
