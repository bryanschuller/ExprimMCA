...
<% if(null != typeD){ %>	
		...
		<li ><a href="<%=strContPath%>/listeDocuments.do" onmouseover="masqueActeSubMenu();"><span id="verticalMiddleSpan">Télécharger</span></a></li>
		
	<% if (null != internaute && internaute.getModeAcces().equals("SUP")) { %>
		<li ><a href="<%=strContPath%>/listeDecSante.do" onmouseover="masqueActeSubMenu();">Mes décomptes santé</a></li>		
	<% } %>
<% } %>
