	...
	<div class="box box-mca-yellow">
		<div class="box-header with-border">
			<h3 class="box-title">
				...
				<a href="<%= (String)request.getContextPath()%>/detailsEchange.do?id=<bean:write name="echange" property="index" />">(d&eacute;tail)</a>
			</h3>
		...
		<div class="box-body">
		    ...
		    &agrave; <layout:write name="echange"  property="lastMsgHeure"  layout="false" type="heure"/>,
